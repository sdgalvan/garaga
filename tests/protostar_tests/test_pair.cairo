...
from src.pair import GTPoint, pair
...
func test_pair{
    ...
    local z_gnark: E12;
    %{
        inputs=[random.randint(0, P-1) for i in range(48)]

        fill_e12('x1', inputs[0], inputs[1], inputs[2], inputs[3], inputs[4], inputs[5], inputs[6], inputs[7], inputs[8], inputs[9], inputs[10], inputs[11])
        fill_e12('y1', inputs[12], inputs[13], inputs[14], inputs[15], inputs[16], inputs[17], inputs[18], inputs[19], inputs[20], inputs[21], inputs[22], inputs[23])
        fill_e12('x2', inputs[24], inputs[25], inputs[26], inputs[27], inputs[28], inputs[29], inputs[30], inputs[31], inputs[32], inputs[33], inputs[34], inputs[35])
        fill_e12('y2', inputs[36], inputs[37], inputs[38], inputs[39], inputs[40], inputs[41], inputs[42], inputs[43], inputs[44], inputs[45], inputs[46], inputs[47])

        cmd = ['./tools/parser_go/main', 'gt', 'pair'] + [str(x) for x in inputs]
    ...
    %}
    let gtpoint1 = GTPoint(x1, y1);
    let gtpoint2 = GTPoint(x2, y2);
    let res = pair(gtpoint1, gtpoint2);
